...
return [
     ...
     */
    "reset_request_notification" => FleetCartApi\Notifications\PasswordResetRequest::class,
    "reset_success_notification" => FleetCartApi\Notifications\PasswordResetSuccess::class,
