...
<?php $__env->startSection('content'); ?>
    <form method="POST" action="<?php echo e(route('admin.products.store')); ?>" class="form-horizontal" id="product-create-form" enctype="multipart/form-data" novalidate>
...
<?php echo $__env->make('admin::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Amp/Modules/Product/Resources/views/admin/products/create.blade.php ENDPATH**/ ?>