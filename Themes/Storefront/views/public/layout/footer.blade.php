            ...
            <div class="footer-middle">
                <div class="row align-items-center">
                    <div class="phone-address">
                        ...
                        <div>
                            <h5>0097137666586</h5>
                            <span>{{ trans('account::attributes.home.working') }}</span>
                        </div>
                    </div>
                    <div class="download">
                        <div class="content">
                            <a href="#">{{ trans('account::attributes.home.footer_download') }}</a>
                            <span>{{ trans('account::attributes.home.footer_discount') }}</span>
                        </div>
                        <div>
                            <span>
