                        ...
                        >
                            <tr>
                                <td style="padding: 0;">
                                    <span style="font-family: 'Open Sans', sans-serif;
                                                ...
                                                display: block;"
                                    >
                                        <?php echo e(trans('checkout::mail.new_order_text', ['order_id' => $order->id])); ?>
                            ...
                            <tr>
                                <td style="padding: 30px 0; text-align: center;">
                                    <a href="<?php echo e(route('admin.orders.show', $order)); ?>" style="font-family: 'Open Sans', sans-serif;
                                                                font-weight: 400;
                                                                text-decoration: none;
                                                                ...
                                                                outline: 0;"
                                    >
                                        <?php echo e(trans('checkout::mail.view_order')); ?>
                            ...
                            <tr>
                                <td style="padding: 0;">
                                    ...
                                    >
                                        <?php echo e(trans('checkout::mail.if_you\’re_having_trouble')); ?>
                            ...
                            <tr>
                                <td style="padding: 0;">
                                    ...
                                    >
                                        <?php echo e(route('admin.orders.show', $order)); ?>
...
<?php /**PATH /var/www/html/amp/Themes/Storefront/views/emails/new_order_rtl.blade.php ENDPATH**/ ?>