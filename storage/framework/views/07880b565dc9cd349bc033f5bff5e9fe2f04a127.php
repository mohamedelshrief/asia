    ...
    <section class="order-details-wrap">
        <div class="container">
            <div class="order-details-top">
                ...
                <div style="float:right"><a class="btn btn-primary" href="<?php echo e(route('account.orders.tracking',$order->id)); ?>"><?php echo e(trans('storefront::account.view_order.track_order')); ?></a></div>
                <div class="row">
...
<?php echo $__env->make('public.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Themes/Storefront/views/public/account/orders/show.blade.php ENDPATH**/ ?>