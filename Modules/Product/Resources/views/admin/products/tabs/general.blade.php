...
<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::text('weight', trans('product::attributes.weight'), $errors, $product, ['required' => true]) }}
        ...
        {{ Form::checkbox('one_time_purchaseable', trans('product::attributes.onetime'), trans('product::products.form.onetime_purchase'), $errors, $product) }}
