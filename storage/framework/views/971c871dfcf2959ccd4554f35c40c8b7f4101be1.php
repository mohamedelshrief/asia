<div class="modal fade" id="bookingModal" tabindex="-1" role="dialog" aria-labelledby="bookingModal" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center">
                            <img src="<?php echo e(url('images/parcel.png')); ?>" width="200px" style="margin-top: 20%"/>
                    </div>
                </div>
                <hr/>
                <h4>Pickup</h4>
  ...
  <?php $__env->startPush('scripts'); ?>
    <script>
        $("#bookingFormAction").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.orders.action.dispatch')); ?>",
                type: "POST",
                data: form_data,
                async: false,
  ...
  <?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/asiamp/Modules/Order/Resources/views/admin/orders/partials/order_placing.blade.php ENDPATH**/ ?>