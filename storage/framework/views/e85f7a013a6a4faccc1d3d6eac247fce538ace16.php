    ...
    <div class="login-page">
        ...
        <div class="login-wrapper">
            ...
            <div class="form-inner clearfix">
                ...
                <form method="POST" action="<?php echo e(route('license.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $errors->first('purchase_code', '<span class="help-block error">:message</span>'); ?>
...
<?php /**PATH /var/www/html/resources/views/license/create.blade.php ENDPATH**/ ?>