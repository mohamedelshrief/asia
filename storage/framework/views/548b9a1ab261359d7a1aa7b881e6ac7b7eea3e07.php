...
<?php $__env->startSection('content'); ?>
    <div class="login-wrapper">
        ...
        <div class="form-inner clearfix">
            <center>
                <img src="<?php echo e(url('/images/logo.png')); ?>" width="60%" />
            </center>
...
<?php echo $__env->make('user::admin.auth.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\apmpllc\Modules/User/Resources/views/admin/auth/login.blade.php ENDPATH**/ ?>